        ...
        return (
            <div>
                <div className="Grade1">
                    <h1>1학년</h1>
                    <div className="btn1">
                        <button className="btn1-1" onClick={this.handleAddSubject1}>추가</button>
                        <button className="btn1-2" onClick={this.handleSave1}>저장</button>
                        <button className="btn1-3" onClick={this.handleDeleteSubjects1}>삭제</button>
                    </div>
                    <table>
                        <thead>
                        <tr>
                            ...
                            <tr key={index}>
                                <td>
                                    <input
                                        ...
                                        onChange={() => this.handleToggleCheck1(index)}
                                    />
                                </td>
                                <td>
                                    <select
                                        name="이수"
                                        value={subject.이수}
                                        onChange={(event) => this.handleInputChange1(event, index)}
                                    >
                        ...
                        <tr>
                            ...
                            <td>{totalSum.기말고사}</td>
                            <td>{totalSum.총점}</td>
                            <td>{this.calculateAverageGrade1()}</td>
                            <td style={{ color: this.calculateGrade1(this.calculateAverageGrade1()) === 'F' ? 'red' : 'black' }}>
                                {this.calculateGrade1(this.calculateAverageGrade1())}
                            </td>
                        </tr>
                        </tfoot>
                    </table>
