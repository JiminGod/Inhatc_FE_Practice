...
class Grade3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            subjects: [],
            ...
            <div>
                <div className="Grade3">
                    ...
                    <div className="button3">
                        <button className="btn3-1" onClick={this.handleAddSubject3}>추가</button>
                        <button className="btn3-2" onClick={this.handleSave3}>저장</button>
                        <button className="btn3-3" onClick={this.handleDeleteSubjects3}>삭제</button>
                    </div>
                    <table>
                        <thead>
                        <tr>
                            ...
                            <tr key={index}>
                                <td>
                                    <input
                                        ...
                                        onChange={() => this.handleToggleCheck3(index)}
                                    />
                                </td>
                                <td>
                                    <select
                                        name="이수"
                                        value={subject.이수}
                                        onChange={(event) => this.handleInputChange3(event, index)}
                                    >
                        ...
                        <tr>
                            ...
                            <td>{totalSum.기말고사}</td>
                            <td>{totalSum.총점}</td>
                            <td>{this.calculateAverageGrade3()}</td>
                            <td style={{ color: this.calculateGrade3(this.calculateAverageGrade3()) === 'F' ? 'red' : 'black' }}>
                                {this.calculateGrade3(this.calculateAverageGrade3())}
                            </td>
                        </tr>
                        </tfoot>
                    </table>
